       ...
       <header id="header" className="header sticky-top">
              ...
              <div className="branding d-flex align-items-cente">
                  <div className="container position-relative d-flex align-items-center justify-content-between">
                      <NavLink to='/dashbord' className="logo d-flex align-items-center">
                          {/* Uncomment the line below if you also wish to use an image logo */}
                          {/* <img src="assets/img/logo.webp" alt=""> */}
                          <h1 className="sitename">Dashbord</h1>
                      </NavLink>
                      <nav id="navmenu" className="navmenu">
                          <ul>
                              ...
                              <li className="dropdown"><a href="#"><span>Room</span> <i className="bi bi-chevron-down toggle-dropdown" /></a>
                                  <ul>
                                      <li><NavLink to="/mangeroom">Mange Room</NavLink></li>
                                      <li><NavLink to="/addroom">Room Add</NavLink></li>
