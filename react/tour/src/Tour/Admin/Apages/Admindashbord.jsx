...
function Admindashbord() {
    ...
    const Update =async (e)=>{
        ...
        try {
            ...
            const res = await axios.put(`http://localhost:3000/Admin/${edit.id}`,edit)
            ...
            localStorage.setItem("aname",edit.name)
        ...
        style={{
          ...
          backgroundSize:"cover",
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    /> */}
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-black">Admin Data Update</h2>
                </div>
