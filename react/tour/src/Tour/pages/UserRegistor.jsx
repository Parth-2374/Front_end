...
function UserRegistor() {
    ...
    const submitdata = async (e) => {
        ...
        if (from.name == "" || from.email == "" || from.password == "") {
            ...
            alert("Pls field data")
            return false;

        }
        try {
            const res =await axios.post("http://localhost:3000/User",from)
            ...
            style={{
              ...
              backgroundSize:"cover",
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                    ...
                    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-black">Sign Up </h2>
                </div>
